...
> **[v1.0.0-dev.5](https://github.com/Okazakee/iptv-morphe-patches/releases/tag/v1.0.0-dev.5)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;2 patches total
<details open>
...
|----------|----------------|-----------|
| [Bypass Play Store install check (IPTV)](#bypass-play-store-install-check-iptv) | Fixes 'Local install check failed due to wrong installer.' by forcing local installer check and license check to pass + disabling paywall activity. |  |
